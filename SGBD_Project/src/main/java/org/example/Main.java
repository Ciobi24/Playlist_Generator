...
import org.example.population.DatabasePopulation;
import org.example.utils.PlaylistBuilder;
...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            log.error("Error when obtaining database connection: " + ex.getMessage());
